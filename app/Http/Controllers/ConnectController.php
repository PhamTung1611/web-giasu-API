                ...
                if ($checkPoint == $confirmTeacher) {
                    ...
                    if ($user && $teacher) {
                        ...
                        if (!$refundMoney) {
                            ...
                            $sendMail->create($connect->id_user, $emailUser, '5', $titleForUser);
                             $sendMail->create($connect->id_teacher, $emailTeacher, '5', $titleForTeacher);
                ...
                if ($checkPoint !== $confirmUser) {
                    ...
                    if ($user && $teacher) {
                        ...
                        if (!$refundMoney) {
                            ...
                            $sendMail->create($connect->id_user, $emailUser, '6', $titleForUser);
                             $sendMail->create($connect->id_teacher, $emailTeacher, '6', $titleForTeacher);
                            $mailController->sendMail($emailUser, $titleForUser);
                            $mailController->sendMail($emailTeacher, $titleForTeacher);
                            return response()->json(['message' => 'Success'], 200);
                        }
