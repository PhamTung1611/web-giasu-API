    ...
    <div class="row align-items-center justify-content-between">
      <div class="col col-md-6 col-lg-3 col-xl-4">
        <form class="input-group me-2 me-lg-3 fmxw-400">
          ...
          <input type="text" class="form-control" placeholder="Search timeslot">
        </form>
      </div>
...
<div class="row">
    <div class="card card-body border-0 shadow mb-4">
      <form action="{{ route('timeslot.add') }}" method="POST" enctype="multipart/form-data" style="width: 1200px" class="mx-auto mb-4">
        @csrf
        <div class="row">
          <div class="col-md-12 mb-3">
              <div>
                  <label>Nhập ca học</label><br>
                  <input type="text" class="form-control" placeholder="Nhập ca học" name="name">
                  @error('name')
