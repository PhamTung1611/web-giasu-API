...
<div class="row">
    ...
    @endforeach
    @endif
        <form action="{{ route('edit_ctv', ['id' => $user->id]) }}" method="POST" enctype="multipart/form-data" style="width: 1200px" class="mx-auto mb-4">
            @csrf
            <div class="row">
                <div class="col-md-12 mb-3">
                    ...
                    <img src="{{$user->avatar ? ''.Storage::url($user->avatar) : ''}}" alt="" id="image_preview" width="100" value="{{$user->avatar}}" >
                    ...
                    Nữ: <input type="radio" name="gender" @if($user->gender == 0) checked @endif id="" value="0"><br>
                    ...
                    Kích hoạt: <input type="radio" name="status" id="" value="1" {{ $user->status == "1" ? "checked":"" }}>
                    Chưa kích hoạt: <input type="radio" name="status" id="" value="0" {{ $user->status == "0" ? "checked":"" }}>
                    @error('class')
