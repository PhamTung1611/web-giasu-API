...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
  ...
  <div class="btn-toolbar mb-2 mb-md-0">
    ...
    <a href="{{ route('add_client') }}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
        ...
        <td>
          <div class="btn-group">
            ...
            <div class="dropdown-menu py-0">
              ...
              <a class="dropdown-item" href="{{ route('edit_client', ['id' => $u->id])}}"><span class="fas fa-edit me-2"></span>Edit</a>
