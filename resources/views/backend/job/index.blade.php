        ...
        <td>
          <div class="btn-group">
            ...
            <div class="dropdown-menu py-0">
              ...
              <a class="dropdown-item" href="{{ route('job.edit', ['id' => $item->id])}}"><span class="fas fa-edit me-2"></span>Edit</a>
              <a class="dropdown-item text-danger rounded-bottom" href="{{ route('job.delete', ['id' => $item->id])}}" onclick="return confirm('Are you sure you want to delete?');"><span class="fas fa-trash-alt me-2"></span>Remove</a>
            </div>
          </div>
        </td>
