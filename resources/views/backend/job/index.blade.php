    ...
    <table border="1" class="table">
        ...
        <tbody>
            <tr>
                ...
                <td>
                    <span class="fw-normal">{{$item->address}}</span>
                </td>
                <td>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <a class="dropdown-item text-danger rounded-bottom" href="{{ route('job.delete', ['id' => $item->id])}}" onclick="return confirm('Are you sure you want to delete?');"><span
