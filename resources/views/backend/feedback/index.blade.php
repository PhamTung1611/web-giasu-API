...
<div class="card card-body border-0 shadow table-wrapper table-responsive">
    <table class="table table-hover">
        ...
        @foreach($feedback as $feedbacks)
            <tr>
                <td>
                    <a href="" class="fw-bold">{{$feedbacks->id}}</a>
                </td>
                <td>
                    <span class="fw-normal">{{$feedbacks->idSender}}</span>
                </td>
                <td>
                    <span class="fw-normal">{{$feedbacks->idTeacher}}</span>
                </td>
                <td>
                    <span class="fw-normal">{{$feedbacks->point}}</span>
                </td>
                <td>
                    <span class="fw-normal">{{$feedbacks->description}}</span>
                </td>
                <td>
                    <div class="btn-group">
