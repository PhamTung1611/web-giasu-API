...
<div class="d-flex justify-content-between flex-wrap flex-md-nowrap align-items-center py-4">
    ...
    <div class="btn-toolbar mb-2 mb-md-0">
      ...
      <a href="{{route('add_class')}}" class="btn btn-sm btn-gray-800 d-inline-flex align-items-center">
            ...
            <tr>
                ...
                <td>
                    <div class="btn-group">
                        ...
                        <a class="dropdown-item" href="{{ route('edit_class', ['id' => $item->id])}}"><span class="fas fa-edit me-2"></span>Sửa</a>
                        <a class="dropdown-item text-danger rounded-bottom" href="{{ route('delete_class', ['id' => $item->id])}}" onclick="return confirm(' Bạn có chắc muốn xóa?');"><span
